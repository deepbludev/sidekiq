...
<task type="auto">
  <name>Task 2: Create model picker components</name>
  <files>
    sidekiq-webapp/src/components/model-picker/model-picker.tsx
    sidekiq-webapp/src/components/model-picker/model-picker-trigger.tsx
    sidekiq-webapp/src/components/model-picker/model-picker-content.tsx
  ...
  <action>
Create model picker component suite. Structure per 04-RESEARCH.md.
...
**3. model-picker/model-hover-card.tsx** - Detail card on hover:
```typescript
"use client";
...
**4. model-picker/model-item.tsx** - Individual model row:
```typescript
"use client";
...
**5. model-picker/model-picker-content.tsx** - Popover content with search:
```typescript
"use client";
...
**6. model-picker/model-picker.tsx** - Main component:
```typescript
"use client";
...
Create the model-picker directory if it doesn't exist.
  ...
  <verify>
- All files exist: `ls sidekiq-webapp/src/components/model-picker/`
...
- TypeScript compiles: `cd sidekiq-webapp && pnpm typecheck`
  ...
  <done>Model picker component suite created with search, favorites, groups, and hover cards</done>
</task>
