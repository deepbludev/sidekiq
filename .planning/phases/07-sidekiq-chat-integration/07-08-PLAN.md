...
3. Add a new FormField for defaultModel after the Avatar picker field (around line 203, after the AvatarPicker FormField closes). The form layout order is: Name, Avatar, then add Model here, then Description follows. Insert:
   ```typescript
   {/* Default Model field */}
   <FormField
