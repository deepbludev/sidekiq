...
must_haves:
  truths:
    - "User can create a Sidekiq with name, description, and instructions"
    - "User can view, update, and delete their Sidekiqs"
    - "Sidekiq data persists correctly across sessions"
    - "Rate limiting prevents spam creation (25 creates/hour)"
    - "Duplicate Sidekiq names are rejected (case-insensitive)"
  artifacts:
