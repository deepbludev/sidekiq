...
4. Click Sidekiq item navigates to /sidekiqs/[id]/edit (NOT /chat?sidekiq=id - that's Phase 7)
  </verify>
  <done>
Sidebar updated with Sidekiqs section showing favorites first, then recent (max 5). Collapsed sidebar has Sidekiqs icon. Section is collapsible with "See all" link when more than 5 Sidekiqs. Clicking a Sidekiq navigates to edit page (chat integration is Phase 7).
  </done>
</task>
...
9. Clicking Sidekiq in sidebar navigates to /sidekiqs/[id]/edit
</verification>
...
- Sidebar click navigates to edit page (not chat - that's Phase 7)
</success_criteria>
